...
test("M1 Rebalance & Foundation Suite (Requirement R1)", async (t) => {
  ...
  // =========================================================================
  await t.test("5.1 'Эффект Бумеранга' grants groundPullSpeed=115 and boomerang flag (no pickup/magnet-range)", () => {
    ...
    assert.equal(player1.stats.groundPullSpeed, 115, "groundPullSpeed should be set to 115");
